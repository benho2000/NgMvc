var app = angular.module('angularTable', ['angularUtils.directives.dirPagination', 'ngTouch', 'ui.grid', 'ui.grid.selection', 'ui.grid.pagination', 'trNgGrid', 'dx']);
...
app.controller("trnggridCtrl", ["$scope", "$http", function ($scope, $http) {
